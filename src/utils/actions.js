...
export const register = async (formData, image) => {
  ...
  if (newUser) {
    await sendEmail(
      newUser.email,
      "Email Verification",
      `<p>Welcome to my Web Application,developed by Hitesh asoria. This is your email verificaiton token. Click here to verify your email! http://localhost:3000/verify/${token}</p>`
    );
