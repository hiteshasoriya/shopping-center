                        ...
                        <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/4">
                            <div className="">
                                <div
                                    ...
                                    style={{ backgroundImage: `url(${item.images?.[0] || item?.product?.images?.[0]} )` }}
                                >
                                ...
                                <div>
                                    <span className="text-sm text-red-500 mr-2 flex items-center">${item?.price || item?.product?.price}</span>
                                    <span className="text-sm text-gray-400 line-through mr-2 flex items-center">${(item?.price || item?.product?.price) + 100}</span>
                                </div>
